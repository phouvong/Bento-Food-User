...
ThemeData light = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF039D55))),
  colorScheme: const ColorScheme.light(primary: Color(0xFF039D55),
