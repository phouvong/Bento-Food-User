...
ThemeData dark = ThemeData(
  ...
  colorScheme: const ColorScheme.dark(primary: Color(0xFFFF4940),
    tertiary: Color(0xff6165D7),
    tertiaryContainer: Color(0xff171DB6),
    secondary: Color(0x9BFF4940)).copyWith(surface: const Color(0xFF272727)).copyWith(error: const Color(0xFFdd3135),
  ),
